...
const EDGES: [string, string][] = [
  ...
  ["GATE_A", "SEC_120"],
  ["GATE_A", "FIRSTAID"],
  ["CONC_MAIN_NE", "MERCH_MAIN"],
  ["CONC_MAIN_NE", "RAMP_NE"],
  ["CONC_MAIN_SW", "RAMP_SW"],
  ["CONC_MAIN_NW", "ELEV_W"],
  ["CONC_MAIN_SE", "TEAM_ENTRY"],
  ["ELEV_E", "CONC_UPPER_SE"],
  ["ELEV_W", "CONC_UPPER_NW"],
  ["RAMP_NE", "CONC_UPPER_NE"],
  ["RAMP_SW", "CONC_UPPER_SW"],
  ["CONC_UPPER_NE", "CONC_UPPER_NW"],
  ["CONC_UPPER_NW", "CONC_UPPER_SW"],
  ["CONC_UPPER_SW", "CONC_UPPER_SE"],
  ["CONC_UPPER_SE", "CONC_UPPER_NE"],
  ["CONC_UPPER_SE", "SEC_214"],
  ["CONC_UPPER_NE", "SEC_320"],
];
